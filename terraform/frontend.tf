...
# Bucket policy granting read access ONLY to this specific CloudFront
# distribution via OAC -- not the whole CloudFront service generally,
# same "confused deputy" scoping pattern already used for S3 and API
# Gateway's Lambda triggers.
